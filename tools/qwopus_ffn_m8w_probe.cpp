...
constexpr int M_n = 32, MH = 8, G = 16, HDR = 32;            // M_n=32 wide
...
static const Shape SH_UP  = {"up",  17408, 5120, 160, 10, 34, 1088};
static const Shape SH_DOWN = {"down", 5120,17408, 544, 34, 10, 320};
...
int main(int argc,char**argv){
    ...
    std::string full_stem=std::getenv("FST_FFN_XCLBIN")?std::getenv("FST_FFN_XCLBIN"):"fst_qwopus_ffn_m8w";
    std::string noop_stem=std::getenv("FST_FFN_NOOP_XCLBIN")?std::getenv("FST_FFN_NOOP_XCLBIN"):"fst_qwopus_ffn_m8w_noop";
    ...
    if(NPKT!=340){fprintf(stderr,"[probe] FATAL NPKT=%d != compiled 340\n",NPKT);return 6;}
